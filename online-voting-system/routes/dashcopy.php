...
<body>
    ...
    <div id="mainSection">
        <div id="profileSection">
            <center><img src="../uploads/shoobh.jpg" <?php echo $data['photo']?> height="100" width="100">
        </center><br>
            <b>Name : </b>
        ...
        <div id="groupSection">
            ...
            <div style="border-bottom: 1px solid #bdc3c7;" "margin-bottom: 10px;">
                <img style="float: right" src="../uploads/vinod salunke.jpg" 
             <?php echo $groups[$i]['photo']?> height="80" width="80">
                <b>Group Name : </b>
                <?php echo $groups[$i]['name']?><br><br>
                <br>
                <br>
    ...
    <div>
        <a href="result.php"> <button id="result"> result </button></a>
    </div>
</body>
